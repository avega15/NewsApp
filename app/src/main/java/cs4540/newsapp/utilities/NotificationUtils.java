...
import cs4540.newsapp.MainActivity;
import cs4540.newsapp.NewsReminderIntentService;
import cs4540.newsapp.R;
import cs4540.newsapp.ReminderTasks;
...
public class NotificationUtils {
    ...
    public static void remindUser(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, NEWS_REFRESH_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                .setContentTitle(context.getString(R.string.refreshing_reminder_notification_title))
                .setContentText(context.getString(R.string.refreshing_reminder_notification_body))
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        context.getString(R.string.refreshing_reminder_notification_body)))
